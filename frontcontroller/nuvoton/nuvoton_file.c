...
#if !defined(HS7110) && !defined(HS7119) && !defined(HS7810A) && !defined(HS7819) && !defined(ATEMIO530)
	if (level < 0 || level > 7)
	{
...
#endif //all other than Octagon1008, FORTIS_HDBOX or ATEVIO7500
			mode = 0;
			break;
		}
		case VFDDRIVERINIT:
