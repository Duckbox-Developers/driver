...
#elif defined(UFS912) || defined(HS7810A) || defined(HS7110) || defined(ATEMIO520) || defined(ATEMIO530) || defined(SPARK)
	.device			= STX7111,
...
#if defined(UFS912) || defined(HS7810A) || defined(HS7110) || defined(ATEMIO520) || defined(ATEMIO530) || defined(SPARK)
                     ...
                     struct plat_tuner_config *tuner_cfg, int i)
{
  ...
  if (cfg->tuner_enable_pin != NULL)
  {
    ...
    stpio_set_pin (cfg->tuner_enable_pin, cfg->tuner_enable_act);
#if defined(UFS912) || defined(HS7810A) || defined(HS7110) || defined(ATEMIO520) || defined(ATEMIO530)
...
#elif defined(HS7810A) || defined(HS7110) || defined(ATEMIO520) || defined(ATEMIO530)
        [0] = {
                .adapter = 0,
                .i2c_bus = 3,
                .i2c_addr = 0x68,
