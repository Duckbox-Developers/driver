...
FrameParserStatus_t FrameParser_VideoVc1_c::ReadPictureHeaderAdvancedProfile(unsigned int first_field)
{
	...
	switch (Header->ptype)
	{
		case VC1_PICTURE_CODING_TYPE_P:
			report(severity_info, "P frame\n");
			break;
		case VC1_PICTURE_CODING_TYPE_B:
			report(severity_info, "B frame\n");
			break;
		case VC1_PICTURE_CODING_TYPE_I:
			report(severity_info, "I frame\n");
			break;
		case VC1_PICTURE_CODING_TYPE_SKIPPED:
			report(severity_info, "Skipped frame\n");
			break;
		case VC1_PICTURE_CODING_TYPE_BI:
			report(severity_info, "BI frame\n");
			break;
	}
#endif
...
FrameParserStatus_t FrameParser_VideoVc1_c::CommitFrameForDecode(void)
{
	...
	if (SequenceHeader->display_ext && SequenceHeader->color_format_flag)
	{
		switch (SequenceHeader->matrix_coef)
		{
			...
			// fall through
			case VC1_MATRIX_COEFFICIENTS_UNSPECIFIED:
