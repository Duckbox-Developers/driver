...
Source file name : collator_pes_audio_mpeg.cpp
Author : Daniel
...
CollatorStatus_t Collator_PesAudioMpeg_c::Reset(void)
{
	CollatorStatus_t Status;
//
	COLLATOR_DEBUG(">><<\n");
	...
	FrameHeaderLength = MPEG_HEADER_SIZE;
