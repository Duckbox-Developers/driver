...
static MME_ERROR InitializeContext(struct PcmContext_s *PcmContext, MME_LxPcmAudioConfig_t *Config)
{
	...
	{
		case 1:
			PcmContext->AudioMode = ACC_MODE10;
			break; /* Mono */
		case 2:
			PcmContext->AudioMode = ACC_MODE20;
			break; /* Stereo */
		case 6:
			PcmContext->AudioMode = ACC_MODE32_LFE;
			break; /* 5,1 */
		default:
	...
	{
		case 8000:
			PcmContext->SamplingFrequency = ACC_FS8k;
			break;
		case 11025:
			PcmContext->SamplingFrequency = ACC_FS11k;
			break;
		case 12000:
			PcmContext->SamplingFrequency = ACC_FS12k;
			break;
		case 16000:
			PcmContext->SamplingFrequency = ACC_FS16k;
			break;
		case 22050:
			PcmContext->SamplingFrequency = ACC_FS22k;
			break;
		case 24000:
			PcmContext->SamplingFrequency = ACC_FS24k;
			break;
		case 32000:
			PcmContext->SamplingFrequency = ACC_FS32k;
			break;
		case 44100:
			PcmContext->SamplingFrequency = ACC_FS44k;
			break;
		case 48000:
			PcmContext->SamplingFrequency = ACC_FS48k;
			break;
		case 88200:
			PcmContext->SamplingFrequency = ACC_FS88k;
			break;
		case 96000:
			PcmContext->SamplingFrequency = ACC_FS96k;
			break;
		case 192000:
			PcmContext->SamplingFrequency = ACC_FS192k;
			break;
		default:
