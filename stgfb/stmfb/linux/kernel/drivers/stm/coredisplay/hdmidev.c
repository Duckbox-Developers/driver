/***********************************************************************
 *
 * File: linux/kernel/drivers/stm/coredisplay/hdmidev.c
...
#if defined(HL101) || defined(VIP1_V2) || defined(VIP2_V1) || defined(SPARK) || defined(SPARK7162) || defined(ADB_BOX) || defined(PACE7241)
