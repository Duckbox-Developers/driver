...
#if (defined(UFS912) || defined(SPARK) || defined(HS7110) || defined(HS7119) || defined(HS7810A) || defined(HS7819) || defined(ATEMIO520) || defined(ATEMIO530) || defined(VITAMIN_HD5000)) && defined(__TDT__)
#define HAS_DSUB 0
...
#elif defined(SPARK) || defined(HS7110) || defined(HS7119) || defined(HS7810A) || defined(HS7819) || defined(ATEMIO520) || defined(ATEMIO530)
