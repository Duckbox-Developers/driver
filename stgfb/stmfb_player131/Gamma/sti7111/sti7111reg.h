/***********************************************************************
 *
 * File: stgfb/Gamma/sti7111/sti7111reg.h
...
#if defined(__TDT__) && (defined(UFS912) || defined(SPARK) || defined(HS7810A) || defined(HS7110)) || defined(WHITEBOX)
...
deprecated_STi7111_BASE_ADDRESS(ULONG address)
{
  return address;
}
#define STi7111_DEI_BASE               deprecated_STi7111_BASE_ADDRESS(STi7111_HD_BASE)
#define STi7111_VDP_BASE               deprecated_STi7111_BASE_ADDRESS(STi7111_SD_BASE)
...
/* STi7111 Sysstatus reg2, HDMI rejection PLL lock ---------------------------*/
